@php
    // Anggap saja $about sudah dilempar dari controller Anda
    // $about = app('App\Http\Controllers\HomeController')->aboutSectionData();
@endphp
