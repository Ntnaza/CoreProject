...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('admin.service-items.create') }}" class="btn btn-primary float-right">Tambah Item Baru</a>
        </div>
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.service-items.edit', $service) }}" class="btn btn-sm btn-warning">Edit</a>
