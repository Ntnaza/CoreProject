...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('team.section.update') }}" method="POST">
                @csrf
                @method('PUT')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('team-members.create') }}" class="btn btn-primary float-right">Tambah Anggota Baru</a>
        </div>
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('team-members.edit', $member) }}" class="btn btn-sm btn-warning">Edit</a>
                            <form action="{{ route('team-members.destroy', $member) }}" method="POST" style="display:inline-block;">
                                @csrf @method('DELETE')
