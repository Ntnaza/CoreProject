...
Route::middleware('auth')->prefix('admin')->group(function () {
    ...
    Route::post('testimonials/section', [TestimonialPageController::class, 'updateSection'])->name('testimonials.section.update');
    Route::resource('testimonial-items', TestimonialController::class)->except(['show', 'index']);
    Route::patch('testimonial-items/{testimonial}/approve', [TestimonialController::class, 'approve'])->name('testimonials.approve');
